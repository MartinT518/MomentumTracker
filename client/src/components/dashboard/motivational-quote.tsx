...
export function DailyMotivation() {
  ...
  return (
    <div className="bg-white/10 backdrop-blur-lg border border-white/20 p-5 rounded-xl shadow-xl overflow-hidden relative text-left mt-[0px] mb-[0px] pt-[0px] pb-[0px] pl-[0px] pr-[0px] ml-[0px] mr-[0px]">
