    ...
    <div className="flex h-screen max-w-full overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto bg-neutral-lighter pt-0 md:pt-4 pb-16 md:pb-4 px-4 md:px-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
          <div>
            <h1 className="text-2xl font-bold font-heading text-neutral-darker">Profile</h1>
            <p className="text-neutral-medium mt-1">Manage your personal details and preferences</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
          <div className="text-center py-12">
            ...
            <p className="text-neutral-medium">Profile management will be available soon.</p>
          </div>
        </div>
      </main>
    </div>
