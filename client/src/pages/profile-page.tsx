...
export default function ProfilePage() {
  ...
  const handleConnectAppleHealth = () => {
    ...
    toast({
      title: "Apple Health",
      description: "Download our iOS app to connect Apple Health data. Search 'CatholicRun' on the App Store.",
    });
  };
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
            <div>
              <div className="flex items-center mb-2">
                <Link href="/">
                  <Button variant="ghost" size="sm" className="mr-2 px-1 text-white hover:text-white/80">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="mt-6 p-4 bg-amber-50 rounded-md border border-amber-200">
                  ...
                  <p className="text-xs text-amber-700 mb-2">
                    By connecting fitness platforms, you consent to CatholicRun accessing your activity and health data to:
                  </p>
